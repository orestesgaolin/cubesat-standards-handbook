...
The product assurance (PA) manager shall ensure that a qualification status list (Template \ref{app:Qualification Status List}) is maintained throughout the project lifetime.
